...
# Huffmancode is a particular type of optimal prefix code
# that is commonlyused for losslessdatacompression.
# Theoutput from Huffmanalgorithmcanbeviewed as avariable - lengthcodetable
# for encodingasourcesymbol(such as acharacter in afile).
# Thealgorithmderivesthistable from theestimatedprobability or
# frequency of occurrence (weight) for each possible value of the source symbol.

# INFORMARTION TAKEN FROM WIKIPEDIA
# FOR MORE INFO: VISIT https://en.wikipedia.org/wiki/Huffman_coding 

# Sample Input 
# 6 -> NO OF SYMBOLS
# a b c d e f -> SYMBOLS
# 40 30 20 5 3 2 -> FREQUENCIES
# Sample Output
# a = 0
# b = 10
# c = 111
